...
import se.aaslin.developer.shoppinglist.android.ui.shoppinglists.view.NewShoppingListElementView;
...
public class NewShoppingListPresenter extends Presenter {
	...
	public NewShoppingListPresenter(View view, Model model, ShoppingListServiceAsync srv, Activity activity) {
		this.view = view;
		this.model = model;
		this.srv = srv;
	...
	private android.view.View createMemberListElement(final int position, android.view.View convertView, String user) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.new_shoppinglist_memberrow, null);
			element = new NewShoppingListElementView();
